...
DONE_OUTLINE = DONE_OUTLINE = SVG_TEMPLATE.format(height="24", color="rgb(103,150,207,0.75)", data="m395-285 339-339-50-51-289 288-119-118-50 50 169 170Zm1 102L124-455l152-152 119 118 289-288 153 153-441 441Z")
